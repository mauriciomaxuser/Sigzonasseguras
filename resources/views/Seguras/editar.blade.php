        ...
        <div class="card-body">
            <form action="{{ route('seguras.update', $segura->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nombre"  value="{{ $segura->nombre }}" name="nombre" >
                </div>
                <label for="">Radio</label>
                <input type="number" name="radio" id="radio" value="{{ $segura->radio }}" class="form-control" placeholder="Porfavor ingrese el radio">

                <label for="">Ubicacion de la alarma</label><br>
                <div class=row>
                    <div class="col-md-6">
                        <label for="">Latitud</label>
                        <input type="text" id="latitud" name="latitud" value="{{ $segura->latitud }}" class="form-control" readonly>
                    </div>
                    <div class="col-md-6">
                        <label for="">Longitud</label>
                        <input type="text" id="longitud" name="longitud" value="{{ $segura->longitud }}"class="form-control" readonly>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="tipo_seguridad" value="{{ $segura->tipo_seguridad }}"name="tipo_seguridad" >
                </div>
