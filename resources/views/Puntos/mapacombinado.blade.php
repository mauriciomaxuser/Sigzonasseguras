...
<div class="container mt-4">
    <div class="card shadow p-4">
        <h1 class="mb-4 text-primary text-center">Mapa Combinado</h1>
        ...
        <div class="d-flex justify-content-end mt-4">
            <a href="{{ route('puntos.index') }}" class="btn btn-danger px-4 me-2">
                <i class="fas fa-arrow-left me-2"></i> REGRESAR
            </a>
            <a href="{{ route('riesgos.index') }}" class="btn btn-secondary px-4 me-2">
                <i class="fas fa-arrow-left me-2"></i> Zonas de Riesgo
            </a>
            <a href="{{ route('seguras.index') }}" class="btn btn-secondary px-4">
                <i class="fas fa-arrow-left me-2"></i> Zonas Seguras
            </a>
        </div>
    </div>
</div>
